...
from BSM.exceptions import CliError, InvalidAccession, FfqException, FailToFetchData
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description=(
            (
                f"BSM {__version__}: A command line tool to find sequencing data "
